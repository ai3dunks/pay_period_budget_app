...
export const PRESETS = {
  clean: {
    ...
    overrides: {
      ...
      transactions: { showRawPlaidDetails: false, showDebugPanels: false },
      recurringBills: { showAdvancedBillRules: false, showDebugPanels: false },
      expenses: { showBucketBudgeting: false, showDebugPanels: false },
      transfers: { showAdvancedTransferMath: false, showDebugPanels: false },
      debtSnowball: { showDebugPanels: false },
      cashFlowForecast: { showScenarioTools: false, showDebugPanels: false },
      reports: { showDebugPanels: false },
      dataHealth: { showDebugPanels: false },
      paycheckPlanner: { showDebugPanels: false },
      history: { showDebugPanels: false },
      settings: { showDataTools: true, showSafeMoney: true, showDebugPanels: false },
    },
  },
  advanced: {
    label: 'Advanced Mode',
    ...
    overrides: {
      ...
      transactions: { showAdvancedFilters: true, showRawPlaidDetails: false, showDebugPanels: false },
      recurringBills: { showAdvancedBillRules: true, showDebugPanels: false },
      expenses: { showBucketBudgeting: true, showDebugPanels: false },
      transfers: { showAdvancedTransferMath: true, showDebugPanels: false },
      debtSnowball: { showDebugPanels: false },
      cashFlowForecast: { showScenarioTools: true, showDebugPanels: false },
      reports: { showDebugPanels: false },
      dataHealth: { showDebugPanels: false },
      paycheckPlanner: { showDebugPanels: false },
      history: { showDebugPanels: false },
...
export const TOGGLE_META = {
  ...
  transactions: {
    ...
    showDebugPanels: { label: 'Debug Panels', description: 'Raw JSON diagnostic output.' },
  },
  recurringBills: {
    show602020BudgetTable: { label: '60/20/20 Budget Table', description: 'Budget allocation breakdown section.' },
  ...
  expenses: {
    ...
    showBucketBudgeting: { label: 'Bucket Budgeting', description: 'Budget bucket allocation display.' },
  ...
  cashFlowForecast: {
    showForecastChart: { label: 'Forecast Chart', description: 'Visual cash flow forecast graph.' },
    showUpcomingBills: { label: 'Upcoming Bills', description: 'List of upcoming bills in the forecast.' },
  ...
  paycheckPlanner: {
    ...
    showBudgetPeriodSelector: { label: 'Budget Period Selector', description: 'Period dropdown on planner.' },
  ...
  history: {
    ...
    showCloseoutHistory: { label: 'Closeout History', description: 'Closeout records per period.' },
